...
export default function InstructionsBlock() {
  ...
  return (
    <section id="instructions" className="relative min-h-screen flex items-center py-24 overflow-hidden bg-[#E6E0D4] scroll-mt-20">
          ...
          <div className="lg:col-span-4 space-y-10">
            <div className="space-y-2">
              <span className="text-xs font-bold tracking-[0.2em] uppercase text-[#9A3412] block mb-2">
                <AnimatedText animationType="fade" dependencyKey={`${currentLanguage}-instructions-subtitle`}>
                  {t("instructions.subtitle") || "HƯỚNG DẪN"}
                </AnimatedText>
              </span>
              <h2 className="text-4xl lg:text-5xl font-bold text-[#7F1D1D] uppercase tracking-tight">
                <AnimatedText animationType="slideUp" dependencyKey={`${currentLanguage}-instructions-title`}>
