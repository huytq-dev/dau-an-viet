...
export default function ContactBlock() {
  ...
  return (
    <section id="contact" className="relative min-h-screen flex items-center py-24 bg-[#E6E0D4] overflow-hidden scroll-mt-20">
      ...
      <div className="container mx-auto px-4 relative z-10 w-full">
        ...
        <div className="text-center mb-16 space-y-4">
          <span className="text-xs font-bold tracking-[0.3em] uppercase text-[#9A3412] block">
            <AnimatedText animationType="fade" dependencyKey={`${currentLanguage}-contact-subtitle`}>
              {t('contact.subtitle')}
            </AnimatedText>
          </span>
          <h2 className="text-4xl lg:text-5xl font-black text-[#7F1D1D] uppercase tracking-tight">
            <AnimatedText animationType="slideUp" dependencyKey={`${currentLanguage}-contact-title`}>
              {t("contact.title")}
            </AnimatedText>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-8 bg-[#FAF9F6] p-8 lg:p-10 rounded-sm border border-[#7F1D1D]/10 shadow-xl shadow-[#4A3728]/5">
            ...
            <h3 className="text-2xl font-bold text-[#7F1D1D] uppercase mb-6 tracking-wide">
              <AnimatedText animationType="fade" dependencyKey={`${currentLanguage}-contact-info`}>
                {t("contact.info")}
              </AnimatedText>
            </h3>
