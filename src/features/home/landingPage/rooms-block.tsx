...
export default function RoomsBlock() {
  ...
  const getPlayers = () => (currentLanguage === 'vi' ? current.playersVi : current.playersEn)

  return (
    <section
      id="rooms"
      className="relative min-h-screen flex items-center py-12 lg:py-24 overflow-hidden bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#360808] via-[#1a0505] to-black scroll-mt-20"
    >
